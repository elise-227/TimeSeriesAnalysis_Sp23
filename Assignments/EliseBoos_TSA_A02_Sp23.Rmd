...
```{r}
#Importing data set
energydat <- read.csv("./Data/Table_10.1_Renewable_Energy_Production_and_Consumption_by_Source-Edit.csv", stringsAsFactors = TRUE)
```
...
ts_energy <- ts(energydat_sel, start = first(energydat_sel$Month), end = last(energydat_sel$Month))
```
