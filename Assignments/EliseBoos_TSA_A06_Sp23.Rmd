...
> Answer: For a moving average model the PACF will decay exponentially and the ACF will identify the order, in this case as a first order moving average model if the first spike is at 1 that is order zero and there will be one additional spike indicating a order of 1. 
