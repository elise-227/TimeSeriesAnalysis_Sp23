...
#Biomass Energy Production plots
plot(ts_energy[,1]) +
title(main="Biomass Energy Prod.")
acf(ts_energy[,1], lag.max =40) 
pacf(ts_energy[,1], lag.max =40)

#Renewable Energy Production plots
plot(ts_energy[,2]) +
title(main="Renewable Energy Prod.") 
acf(ts_energy[,2], lag.max =40)
pacf(ts_energy[,2], lag.max =40)

#Hydroelectric Power Consumption plots
plot(ts_energy[,3]) +
title(main="Hydroelectric Power Cons.")
